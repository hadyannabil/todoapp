    ...
    <div class="card" style="text-align:center; padding:3rem;">
        <div style="margin-bottom:1.2rem; display:flex; justify-content:center;">
            <svg width="64" height="64" viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg">
                <rect width="64" height="64" rx="16" fill="#1a1828"/>
                <rect x="16" y="20" width="32" height="4" rx="2" fill="#7c6cfc" opacity="0.9"/>
                <rect x="16" y="30" width="24" height="4" rx="2" fill="#7878a0" opacity="0.7"/>
                <rect x="16" y="40" width="20" height="4" rx="2" fill="#7878a0" opacity="0.5"/>
                <circle cx="48" cy="44" r="8" fill="#7c6cfc"/>
                <rect x="47" y="40" width="2" height="4" rx="1" fill="white"/>
                <rect x="47" y="46" width="2" height="2" rx="1" fill="white"/>
            </svg>
        </div>
